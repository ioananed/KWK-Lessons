...
class ViewController: UIViewController {
    ...
    @IBAction func nextButton(_ sender: UIButton) {
        ...
        var randomColor = randomColors[Int.random(in: 0..<randomColors.count)]
        textFact.backgroundColor = randomColor
